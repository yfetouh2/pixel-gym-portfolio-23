...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "TikiTaka League is a social soccer management app designed for players who love to play regularly. Create groups, schedule matches, manage attendance, and never miss a game again.",
    image: "⚽",
